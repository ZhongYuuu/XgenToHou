...
#include "xgen/src/xgtask/XgArchivePrimitiveContext.h"
...
public:
    ...
    void createContext();
    virtual XgBasePrimitiveContext* cloneContextImp();
...
protected:
    ...
    virtual void mkGeometryInParallel( XgBasePrimitiveContext& context1, double u, double v );
