#ifndef XGCARDPRIMITIVECONTEXT_H
#define XGCARDPRIMITIVECONTEXT_H

#include "xgen/src/xgtask/XgPrimitiveContext.h"

class XGEN_EXPORT XgCardPrimitiveContext: public XgPrimitiveContext
{
	friend class XgCardPrimitive;

public:
    explicit XgCardPrimitiveContext( XgDescription* descr );
    virtual ~XgCardPrimitiveContext();
