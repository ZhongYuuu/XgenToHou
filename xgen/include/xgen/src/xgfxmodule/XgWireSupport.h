...
#include "xpd/src/core/XpdFileCachedReader.h"
...
public:
    ...
    int bindCVInParallel( XgWireSupportContext & wireContext,
                const SgVec3d &cv,
                SgVec3d &coord,
                unsigned int &quadrant );
    ...
    SgVec3d computeGoalPtInParallel( XgWireSupportContext & wireContext,
    ...
    void buildFrameVectorsInParallel( XgWireSupportContext & wireContext,
...
public:
	...
	/** The Clumping guides. */
	struct clumpGuide {
		clumpGuide(): curlMutex(NULL), valid(false) {}
		bool valid;
		double u;
		double v;
		unsigned int faceId;
