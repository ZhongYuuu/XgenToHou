...
def main( argc, argv ):
	...
	# Workaround a crash when bifrostshellnode is loaded by mtoa. mtoa imports
	# pymel.core and then the auto-load bifrostshellnode is loaded. This caused
	# a crash in bifrost code. We imports pymel.core here so that bifrost
	# plug-ins are not loaded in mtoa.
	try:
