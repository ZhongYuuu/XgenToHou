...
def caps2guides (density, xuv):
    ...
    errTitle = maya.stringTable[u'y_xgenm_xmaya_xgmCaps2GuidesTool.kCaps2GuidesErrTitle' ]
    # either xuv or density must be set
    if not xuv and density==0.0:
        errText = maya.stringTable[u'y_xgenm_xmaya_xgmCaps2GuidesTool.kCaps2GuidesErrSpecifyDensity' ]
    ...
    if xgg.DescriptionEditor == None:
        errText = maya.stringTable[u'y_xgenm_xmaya_xgmCaps2GuidesTool.kCaps2GuidesErrNeedDescEditorOpen' ]
        cmd = 'confirmDialog -title "%s" -m "%s" -messageAlign "left" -button "Ok"' % (errTitle, errText)
        mel.eval(cmd)
        return
    ...
    if not tempDesc:
        errText = maya.stringTable[u'y_xgenm_xmaya_xgmCaps2GuidesTool.kCaps2GuidesErrCreateWorkingAreaFailed' ]
        cmd = 'confirmDialog -title "%s" -m "%s" -messageAlign "left" -button "Ok"' % (errTitle, errText)
        mel.eval(cmd)
        return
    tempDesc = str(tempDesc[0])

    print(maya.stringTable[u'y_xgenm_xmaya_xgmCaps2GuidesTool.kXgmCaps2GuidesToolCreateWorkingArea' ], tempDesc)
    ...
    print(maya.stringTable[u'y_xgenm_xmaya_xgmCaps2GuidesTool.kXgmCaps2GuidesToolCreateFirstPass' ])
    ...
    print(maya.stringTable[u'y_xgenm_xmaya_xgmCaps2GuidesTool.kXgmCaps2GuidesToolInitAndRender' ])
    ...
    confirmTitle = maya.stringTable[u'y_xgenm_xmaya_xgmCaps2GuidesTool.kCapsToGuidesComplete' ]
    confirmText = maya.stringTable[u'y_xgenm_xmaya_xgmCaps2GuidesTool.kCapsToGuidesFinishCreating' ] % len(guides)
