...
_locNames = {"Pose"     :maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kPose'  ],
             "Orient"   :maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kOrient'  ],
             "Bend"     :maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kBend'  ],
             "Twist"    :maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kTwist'  ],
             "Elevation":maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kElevation'  ],
             "Noise"    :maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kNoise'  ],
             "Length"   :maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kLength'  ],
             "Width"    :maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kWidth'  ],
             "Attract"  :maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kAttract'  ],
             "Repel"    :maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kRepel'  ],
             "Part"     :maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kPart'  ],
             "Smooth"   :maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kSmooth'  ],
             "Mask"     :maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMask'  ],
             "Eraser"   :maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kEraser'  ],
             "Region"   :maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kRegion'  ]}
...
class BaseBrush(QWidget):    
    ...
    def invoke(self):
        ...
        cmd = '$gIgActiveBrush="%s";ig%sBrushInit();' % (brushName,brushName)
        mel.eval( cmd )
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushSpacingField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kSpacing'  ]+self._spacing, f=True, cw=self._columnWidth, 
                            min=0.001, max=1.0, pre=3, step=0.02, v=sp,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kSpacingAnn'  ],
        ...
        w = _createWidget( cmds.radioButtonGrp, 'igBrushFalloffField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kFalloff'  ]+self._spacing, nrb=4, sl=fo, 
                            cw5=[self._mainColumnWidth,self._radioWidth,self._radioWidth,self._radioWidth,self._radioWidth],
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kFalloffAnn'  ],
                            la4=[maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kGauss'  ],
                                 maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kSmooth2'  ],
                                 maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kLinear'  ],
                                 maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kImpulse'  ]],
                            onc='xgen.ui.brushes.xgBrush._updateFromRadio("igBrushFalloff")' )
        self.brushWidget.addWidget(w)     

        mm = self._addSetting( 'igBrushMaskUse', 1, _updateRadio )
        w = _createWidget( cmds.radioButtonGrp, 'igBrushMaskUseField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMask1'  ]+self._spacing, nrb=2, sl=mm, 
                            cw=self._columnWidth, 
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMaskAnn'  ],
                            la2=[maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kApplyWithin'  ],
                                 maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kApplyOutside'  ]],
...
class Pose(BaseBrush):    
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushPoseOrientMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kOrientation1'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude0,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kOrientationAnn1'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushPoseOrientMag")' )
        self.brushWidget.addWidget(w)     

        w = _createWidget( cmds.floatSliderGrp, 'igBrushPoseBendMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kBend1'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude1,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kBendAnn1'  ],
...
class Orient(BaseBrush):    
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushOrientMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMagnitude1'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude0,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMagnitudeAnn1'  ],
...
class Bend(BaseBrush):    
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushBendMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMagnitude2'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude0,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMagnitudeAnn2'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushBendMag")' )
        self.brushWidget.addWidget(w)     

    def uiInfo(self):
        return (maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kBend3'  ],'iGroom_bend.png')
...
class Twist(BaseBrush):    
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushTwistMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kDegrees1'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=10.0, fmx=30.0, pre=3, step=0.02, v=igBrushMagnitude0,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kDegreesAnn1'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushTwistMag")' )
        self.brushWidget.addWidget(w)     

    def uiInfo(self):
        return (maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kTwist2'  ],'iGroom_twist.png')
...
class Elevation(BaseBrush):    
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushElevDegreesField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kDegrees2'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=-10.0, max=10.0, fmn=-90.0, fmx=90.0, pre=2, step=0.5, v=igBrushMagnitude0,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kDegreesAnn2'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushElevDegrees")' )
        self.brushWidget.addWidget(w)     

        w = _createWidget( cmds.floatSliderGrp, 'igBrushElevGoalAngleField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kGoalAngle'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=90.0, pre=2, step=0.5, v=igBrushMagnitude1,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kGoalAngleAnn'  ],
...
class Noise(BaseBrush):    
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushNoiseMidMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMiddle'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude0,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMiddleAnn'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushNoiseMidMag")' )
        self.brushWidget.addWidget(w)     

        w = _createWidget( cmds.floatSliderGrp, 'igBrushNoiseTipMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kTip'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude1,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kTipAnn'  ],
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushNoiseWidthMagField', l=_locNames['Width']+self._spacing, f=True, cw=self._columnWidth,
                            ...
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kWidthAnn'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushNoiseWidthMag")' )
        self.brushWidget.addWidget(w)     

        w = _createWidget( cmds.floatSliderGrp, 'igBrushNoiseOffNDegreesField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kOff'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=10.0, pre=3, fmx=90.0, step=0.02, v=igBrushMagnitude3,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kOffAnn'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushNoiseOffNDegrees")' )
        self.brushWidget.addWidget(w)     

        w = _createWidget( cmds.floatSliderGrp, 'igBrushNoiseAboutNDegreesField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kAround'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=10.0, pre=3, fmx=90.0, step=0.02, v=igBrushMagnitude4,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kAboutAnn'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushNoiseAboutNDegrees")' )
        self.brushWidget.addWidget(w)     

        w = _createWidget( cmds.floatSliderGrp, 'igBrushNoiseTwistDegreesField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kTwist3'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=10.0, pre=3, fmx=90.0, step=0.02, v=igBrushMagnitude5,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kTwistAnn'  ],
...
class Length(BaseBrush):    
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushLengthIncrField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kIncrement1'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=-1.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude0,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kIncrementAnn1'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushLengthIncr")' )
        self.brushWidget.addWidget(w)     

        w = _createWidget( cmds.floatSliderGrp, 'igBrushLengthGoalField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kGoalLength'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, fmx=5000.0, pre=3, step=0.02, v=igBrushMagnitude1,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kGoalLengthAnn'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushLengthGoal")' )
        self.brushWidget.addWidget(w)     
            
    def uiInfo(self):
        return (maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kLength2'  ],'iGroom_length.png')
...
class Width(BaseBrush):    
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushWidthIncrField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kIncrement2'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=-1.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude0,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kIncrementAnn2'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushWidthIncr")' )
        self.brushWidget.addWidget(w)     

        w = _createWidget( cmds.floatSliderGrp, 'igBrushWidthGoalField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kGoalWidth'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, fmx=10.0, pre=3, step=0.02, v=igBrushMagnitude1,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kGoalWidthAnn'  ],
...
class Attract(BaseBrush):    
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.radioButtonGrp, 'igBrushAttractStyleField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kStyle'  ]+self._spacing, nrb=2, sl=igBrushMagnitude0, 
                            cw=self._columnWidth,la2=[maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kLock'  ],
                                          maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kFloat'  ]],
                            ann=(maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kStyleAnn'  ]),
                            onc='xgen.ui.brushes.xgBrush._updateFromRadio("igBrushAttractStyle")' )
        self.brushWidget.addWidget(w)     

        w = _createWidget( cmds.floatSliderGrp, 'igBrushAttractMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMagnitude3'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude1,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMagnitudeAnn3'  ],
...
class Repel(BaseBrush):    
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushRepelMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMagnitude4'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude0,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMagnitudeAnn4'  ],
...
class Part(BaseBrush):    
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushPartMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMagnitude5'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude0,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMagnitudeAnn5'  ],
...
class Smooth(BaseBrush):    
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushSmoothLengthMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kLength3'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude0,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kLengthAnn3'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushSmoothLengthMag")' )
        self.brushWidget.addWidget(w)     

        w = _createWidget( cmds.floatSliderGrp, 'igBrushSmoothOrientMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kOrientation2'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude1,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kOrientationAnn2'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushSmoothOrientMag")' )
        self.brushWidget.addWidget(w)     
        
        w = _createWidget( cmds.floatSliderGrp, 'igBrushSmoothBendMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kBend4'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude2,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kBendAnn4'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushSmoothBendMag")' )
        self.brushWidget.addWidget(w)     

    def uiInfo(self):
        return (maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kSmooth3'  ],'iGroom_smooth.png')
...
class Mask(BaseBrush):    
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushMaskMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMagnitude6'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=-0.25, max=1.0, fmn=-1.0, pre=3, step=0.01, v=igBrushMagnitude0,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMagnitudeAnn6'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushMaskMag")' )
        self.brushWidget.addWidget(w)                 

    def uiInfo(self):
        return (maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kMask3'  ],'iGroom_mask.png')
...
class Eraser(BaseBrush):    
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.floatSliderGrp, 'igBrushEraserLengthMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kLength4'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude0,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kLengthAnn4'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushEraserLengthMag")' )
        self.brushWidget.addWidget(w)

        w = _createWidget( cmds.floatSliderGrp, 'igBrushEraserOrientMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kOrientation3'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude1,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kOrientationAnn3'  ],
                            cc='xgen.ui.brushes.xgBrush._updateFromSlider("igBrushEraserOrientMag")' )
        self.brushWidget.addWidget(w)     
        
        w = _createWidget( cmds.floatSliderGrp, 'igBrushEraserBendMagField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kBend5'  ]+self._spacing, f=True, cw=self._columnWidth,
                            min=0.0, max=1.0, pre=3, step=0.02, v=igBrushMagnitude2,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kBendAnn5'  ],
...
class Region(BaseBrush):
    ...
    def buildUI(self):
        ...
        w = _createWidget( cmds.colorSliderGrp, 'igBrushRegionColorField', l=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kColor'  ]+self._spacing, 
                            rgb=[igBrushMagnitude0,igBrushMagnitude1,igBrushMagnitude2],
                            cw=self._columnWidth,
                            ann=maya.stringTable[ u'y_xgenm_ui_brushes_xgBrush.kColorAnn'  ],
