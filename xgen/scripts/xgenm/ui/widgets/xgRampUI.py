...
class RampUI(QWidget):
    ...
    def __init__(self,attr,help="",object="",mainlabel=""):
        ...
        self.setAccessibleName(r'XgRampUI')
        # Widgets
        if mainlabel != "":
        ...
        self.rampValue = xgRampWidget(maya.stringTable[ u'y_xgenm_ui_widgets_xgRampUI.kSelPosition'  ],
                                      maya.stringTable[ u'y_xgenm_ui_widgets_xgRampUI.kSelValue'  ],
                                      maya.stringTable[ u'y_xgenm_ui_widgets_xgRampUI.kInterpolation'  ])
        self.popRamp = None

        self.button = QPushButton(">")
        self.button.setFixedSize(DpiScale(20), DpiScale(120))
        self.button.setToolTip(maya.stringTable[ u'y_xgenm_ui_widgets_xgRampUI.kPopRampWindow' ])
    ...
    def setValue(self,value):
        ...
        if not value.startswith("rampUI("):
            print(maya.stringTable[u'y_xgenm_ui_widgets_xgRampUI.kRampUIInvalidValue' ], self.attr, value)
            return
...
class PopRampUI(QWidget):
    ...
    def __init__(self,RampCurve,attr,object=""):
        ...
        self.rampValue = xgRampWidget(maya.stringTable[ u'y_xgenm_ui_widgets_xgRampUI.kSelPositionRamp'  ],
                                      maya.stringTable[ u'y_xgenm_ui_widgets_xgRampUI.kSelValueRamp'  ],
                                      maya.stringTable[ u'y_xgenm_ui_widgets_xgRampUI.kInterpolationRamp'  ], 
                                      RampCurve,None, 413)
