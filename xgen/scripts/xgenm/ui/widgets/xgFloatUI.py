...
class Slider(QSlider):
    def __init__(self,direction):
        ...
        self.setAccessibleName(r'XgSlider')
...
class FloatUI(QWidget):
    ...
    def __init__(self,attr,help="",object="",dMin=-1000000.0,dMax=1000000.0,uiMin=-1000,uiMax=1000,mainlabel="",autoPlayblast=True):
        ...
        self.setAccessibleName(r'XgFloatUI')
        ...
        self.floatValue = QLineEdit()
        self.validate = MayaQclocaleDoubleValidator(self.dMin,self.dMax, 6,self.floatValue)
        ...
        self.floatValue.setFixedWidth(DpiScale(62))
        # Horizontal layout
        layout = QHBoxLayout()
    ...
    def setFieldWidth(self, width):
        self.floatValue.setFixedWidth(DpiScale(width))

    def myFixup(self,value):
        print( "myFixup", type( self ) )
        # QmayaDoubleValidator.fixup( self.validate, value )
    ...
    def editChanged(self):
        # value = self.value()
        # self.validate.fixup( value )
        # self.saetValue = value
