...
class IntegerUI(QWidget):
    ...
    def __init__(self,attr,help="",object="",iMin=-1e7,iMax=1e8,mainlabel="",autoPlayblast=True):
        ...
        self.setAccessibleName(r'XgIntegerUI')
        ...
        self.intValue = QLineEdit()
        self.validate = QIntValidator(self.iMin,self.iMax,
                                            self.intValue)
        self.validate.fixup = self.myFixup
        self.intValue.setValidator(self.validate)
        self.intValue.setFixedWidth(DpiScale(62))
        filler = QWidget()
        # Horizontal layout
        layout = QHBoxLayout()
