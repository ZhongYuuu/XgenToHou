...
class FXModuleTabUI(QWidget):
    ...
    def baseTopUI(self):
        ...
        self.maskExpr = ExpressionUI("mask",
             maya.stringTable[ u'y_xgenm_ui_fxmodules_xgFXModuleTab.kMaskAnn'  ],
             self.name,
             maya.stringTable[ u'y_xgenm_ui_fxmodules_xgFXModuleTab.kMask'  ])
...
class FXModuleTabBlankUI(FXModuleTabUI):
    ...
    def __init__(self, typename, printablename = None):
        ...
        if printablename:
            ...
            labeltext = typename
        label = QLabel(maya.stringTable[ u'y_xgenm_ui_fxmodules_xgFXModuleTab.kNoExtraAttributes'  ] % labeltext)
