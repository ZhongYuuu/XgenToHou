...
class ApplyNetForceFXModuleTabUI(FXModuleTabUI):
    def __init__(self,name):
        FXModuleTabUI.__init__(self,name,maya.stringTable[ u'y_xgenm_ui_fxmodules_xgApplyNetForceFXModuleTab.kApplyNetForceModifier'  ])
        # Widgets
        self.baseTopUI()
        
        self.stiffness = ExpressionUI("stiffness",
             maya.stringTable[ u'y_xgenm_ui_fxmodules_xgApplyNetForceFXModuleTab.kStiffnessAnn'  ],
             self.name,
             maya.stringTable[ u'y_xgenm_ui_fxmodules_xgApplyNetForceFXModuleTab.kStiffness'  ])
        self.layout().addWidget(self.stiffness)
        
        self.stiffnessScale = RampUI("stiffnessScale",
                           maya.stringTable[ u'y_xgenm_ui_fxmodules_xgApplyNetForceFXModuleTab.kStiffnessScaleAnn'  ],
                           self.name,
                           maya.stringTable[ u'y_xgenm_ui_fxmodules_xgApplyNetForceFXModuleTab.kStiffnessScale'  ])
