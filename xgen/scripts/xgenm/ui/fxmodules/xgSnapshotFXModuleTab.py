...
class SnapshotFXModuleTabUI(FXModuleTabUI):
    def __init__(self,name):
        FXModuleTabUI.__init__(self,name,maya.stringTable[ u'y_xgenm_ui_fxmodules_xgSnapshotFXModuleTab.kSnapshotModifier'  ])
        # Widgets
        self.baseTopUI()
        
        self.snapshotDir = BrowseUI("snapshotDir",
             maya.stringTable[ u'y_xgenm_ui_fxmodules_xgSnapshotFXModuleTab.kSnapshotDirAnn'  ],
             self.name,"","in",
             maya.stringTable[ u'y_xgenm_ui_fxmodules_xgSnapshotFXModuleTab.kSnapshotDir'  ])
        self.layout().addWidget(self.snapshotDir)

        self.magnitude = ExpressionUI("magnitude",
             maya.stringTable[ u'y_xgenm_ui_fxmodules_xgSnapshotFXModuleTab.kMagnitudeAnn'  ],
             self.name,
             maya.stringTable[ u'y_xgenm_ui_fxmodules_xgSnapshotFXModuleTab.kMagnitude'  ])
        ...
        if ( xgg.Maya ):
            ...
            self.snapButton = QPushButton(maya.stringTable[ u'y_xgenm_ui_fxmodules_xgSnapshotFXModuleTab.kSnapshot'  ])
    ...
    def snapSlot(self):
        ...
        # display results
        print(maya.stringTable[ u'y_xgenm_ui_fxmodules_xgSnapshotFXModuleTab.kTheFollowingFiles'  ])
        print(files)
