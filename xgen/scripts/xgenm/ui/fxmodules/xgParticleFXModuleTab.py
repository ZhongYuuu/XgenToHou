...
class ParticleFXModuleTabUI(FXModuleTabUI):
    def __init__(self,name):
        FXModuleTabUI.__init__(self,name,maya.stringTable[ u'y_xgenm_ui_fxmodules_xgParticleFXModuleTab.kParticleModifier'  ])
        # Widgets
        self.baseTopUI()

        self.particleFile = BrowseUI("particleFile",
             maya.stringTable[ u'y_xgenm_ui_fxmodules_xgParticleFXModuleTab.kParticleFileAnn'  ],
             self.name,"*.pda *.pdb *.bgeo","in",
             maya.stringTable[ u'y_xgenm_ui_fxmodules_xgParticleFXModuleTab.kParticleFile'  ])
        ...
        if ( xgg.Maya ):
            ...
            self.bakeButton = QPushButton(maya.stringTable[ u'y_xgenm_ui_fxmodules_xgParticleFXModuleTab.kBakeParticles'  ])
    ...
    def bakeSlot(self):
        ...
        setProgressInfo(maya.stringTable[u'y_xgenm_ui_fxmodules_xgParticleFXModuleTab.kParticleFXRenderingProgress' ])
