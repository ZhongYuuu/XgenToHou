...
class PointsBaseUI(QDialog):
    ...
    def pointDirUI(self,layout,attr,help,object="",mainlabel=""):
        ...
        self.pointDir.optionButton.setToolTip(maya.stringTable[ u'y_xgenm_ui_dialogs_xgPointsBase.kFileBrowserAnn'  ])
        if object:
    ...
    def ptLengthUI(self,layout,object=""):
        self.ptLength = FloatUI("ptLength",
             maya.stringTable[ u'y_xgenm_ui_dialogs_xgPointsBase.kPtLengthAnn'  ],
             object,0.0,1000000,0.1,5.0)
        self.ptLength.label.setText(maya.stringTable[ u'y_xgenm_ui_dialogs_xgPointsBase.kPtLength'  ])
