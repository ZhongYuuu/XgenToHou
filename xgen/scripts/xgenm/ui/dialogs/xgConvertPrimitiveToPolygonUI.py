...
def composeConvertCmd(setting):
    # XGen only can select primitive from current active description,
    # if "convertSelected" is on, use the current active description
    descriptions = getDescriptionToConvert(setting.convertSelected)
    if len(descriptions) == 0:
        xglog.XGWarning(maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kNoDesc' ] )
        return ""
...
class GeometryRendererSetting(object):
    ...
    def __init__(self):
        ...
        # keys for optionVar
        self.kConvertSelected       = 'xgGeometryRender_ConvertSelected'
        self.kCombineMesh           = 'xgGeometryRender_CombineMesh'
        self.kUseWidthRamp          = 'xgGeometryRender_UseWidthRamp'
        self.kInsertWidthSpan       = 'xgGeometryRender_InsertWidthSpan'
        self.kWidthSpanNum          = 'xgGeometryRender_WidthSpanNum'
        self.kCurvature             = 'xgGeometryRender_Curvature'
        self.kUVInTiles             = 'xgGeometryRender_UVInTiles'
        self.kUVLayoutType          = 'xgGeometryRender_UVLayoutType'
        self.kUVTileSeparation      = 'xgGeometryRender_UVTileSeparation'
        self.kCreateStripJoints     = 'xgGeometryRender_CreateStripJoints'
        self.kStripJointPlacementType = 'xgGeometryRender_StripJointPlacementType'
        self.kJointNumOnStrip       = 'xgGeometryRender_JointNumOnStrip'
        self.kAutoBindSkin          = 'xgGeometryRender_AutoBindSkin'
        self.kMaxInfluences         = 'xgGeometryRender_MaxInfluences'
        self.kCreateGuideJoints     = 'xgGeometryRender_CreateGuideJoints'
        self.kGuideJointPlacementType = 'xgGeometryRender_GuideJointPlacementType'
        self.kJointNumOnGuide       = 'xgGeometryRender_JointNumOnGuide'
...
class ConvertPrimitiveToPolygonWindow(QMainWindow):
    ...
    def __init__(self, parent):
        ...
        # Window title
        self.setWindowTitle( maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kConvertPrimToPolyWinTitle' ])
        ...
        self.convertSelectedChkBoxUI = QCheckBox(maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kConvertSelected' ])
        ...
        self.combineMeshChkBoxUI = QCheckBox(maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kCombineMesh' ])
        ...
        self.useWidthRampChkBoxUI = QCheckBox(maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kUseWidthRamp' ])
        gridLayout.addWidget(self.useWidthRampChkBoxUI, gridLine, 1, 1, 2)
        gridLine += 1

        # 'Insert Spans Along Width' check box
        self.insertSpansChkBoxUI = QCheckBox(maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kInsertSpans' ])
        ...
        self.spanNumIntUI = IgIntSliderUI(
                maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kSpanNum' ],
                maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kkSpanNumAnno' ],
                True,
                0, 100, 0, 10,
                gridLayout, gridLine,
        ...
        self.curvatureFloatUI = IgFloatSliderUI(
                maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kCurvature' ],
                maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kCurvatureAnno' ],
                True,
                -1.0, 1.0, -1.0, 1.0,
                gridLayout, gridLine,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        self.placeUVChkBoxUI = QCheckBox(maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kPlaceUV' ])
        ...
        # UV Layout Type
        self.uvLayoutTypeLabelUI = QLabel(maya.stringTable[ u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kUVLayoutType'  ])
        ...
        self.uvLayoutTypeComboUI.addItem(maya.stringTable[ u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.k2x2' ])
        self.uvLayoutTypeComboUI.addItem(maya.stringTable[ u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.k3x3' ])
        self.uvLayoutTypeComboUI.addItem(maya.stringTable[ u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.k4x4' ])
        ...
        self.tileSeparationFloatUI = IgFloatSliderUI(
                maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kTileSeparation' ],
                maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kTileSeparationAnno' ],
                True,
                0.0, 1.0, 0.0, 1.0,
                gridLayout, gridLine,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        self.createStripJointsChkBoxUI = QCheckBox(maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kCreateStripJoints' ])
        ...
        jointPlacementStr = maya.stringTable[ u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kJointPlacement'  ]
        jointPerSpanStr = maya.stringTable[ u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kJointPerSpan'  ]
        jointPerCVStr = maya.stringTable[ u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kJointPerCV'  ]
        specifyJointNumStr = maya.stringTable[ u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kSpecifyJointNum'  ]
        ...
        self.stripJointNumIntUI = IgIntSliderUI(
                maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kStripJointNum' ],
                maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kStripJointNumAnno' ],
                True,
                3, 100, 3, 10,
                gridLayout, gridLine,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        # Auto Bind Skin
        self.autoBindSkinChkBoxUI = QCheckBox(maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kAutoBindSkin' ])
        ...
        self.maxInfluencesIntUI = IgIntSliderUI(
                maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kMaxInfluences' ],
                maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kMaxInfluencesAnno' ],
                True,
                3, 100, 3, 10,
                gridLayout, gridLine,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        self.createGuideJointsChkBoxUI = QCheckBox(maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kCreateGuideJoint' ])
        ...
        self.guideJointNumIntUI = IgIntSliderUI(
                maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kGuideJointNum' ],
                maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kGuideJointNumAnno' ],
                True,
                3, 100, 3, 10,
                gridLayout, gridLine,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        self.convertButton = QPushButton(maya.stringTable[ u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kConvert'  ])
        ...
        self.applyButton = QPushButton(maya.stringTable[ u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kApply'  ])
        ...
        self.cancelButton = QPushButton(maya.stringTable[ u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kCancel'  ])
    ...
    def __createMenus(self):
        ...
        # Edit menu
        editMenu = self.menuBar().addMenu(maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kEdit' ])
        editMenu.addAction(maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kResetSettings' ], self.__onMenuResetSettings)
        editMenu.addAction(maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kSaveSettings' ], self.__onMenuSaveSettings)

        # Help menu
        helpMenu = self.menuBar().addMenu(maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kHelp' ])
        helpMenu.addAction(maya.stringTable[u'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kHelpMenu' ], self.__onMenuHelp)
