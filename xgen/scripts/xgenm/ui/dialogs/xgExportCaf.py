...
class ExportCafUI(QDialog):
    ...
    def __init__(self):
        ...
        self.setWindowTitle(maya.stringTable[ u'y_xgenm_ui_dialogs_xgExportCaf.kXgenCafExport'  ])
        self.setSizeGripEnabled(True)
        self.setMinimumWidth(DpiScale(550))
        global ExportCafFileName, ExportCafStartFrame, ExportCafEndFrame
        layout = QVBoxLayout()
        self.fileName = BrowseUI(maya.stringTable[ u'y_xgenm_ui_dialogs_xgExportCaf.kCafFile'  ],
                                 maya.stringTable[ u'y_xgenm_ui_dialogs_xgExportCaf.kCafFileAnn'  ],"",
                                 "*.caf","out")
        self.fileName.setValue(ExportCafFileName)
        layout.addWidget(self.fileName)
        self.anim = CheckBoxUI(maya.stringTable[ u'y_xgenm_ui_dialogs_xgExportCaf.kAnimated'  ],
                               maya.stringTable[ u'y_xgenm_ui_dialogs_xgExportCaf.kAnimatedAnn'  ])
        self.anim.setValue(False)
        self.connect(self.anim.boxValue[0],
                     QtCore.SIGNAL("clicked(bool)"),
                     lambda x: self.animUpdate())
        layout.addWidget(self.anim)
        self.startFrame = FloatUI(maya.stringTable[ u'y_xgenm_ui_dialogs_xgExportCaf.kFrameRange'  ],
                                  maya.stringTable[ u'y_xgenm_ui_dialogs_xgExportCaf.kFrameRangeAnn'  ],-1000000,1000000,0.0,1000)
        self.startFrame.setValue(ExportCafStartFrame)
        layout.addWidget(self.startFrame)
        rbox = self.startFrame.layout()
        rbox.addSpacing(DpiScale(5))
        self.endFrame = QLineEdit()
        self.endFrame.setValidator(MayaQclocaleDoubleValidator(-1000000.0,1000000.0,6,self.endFrame))
        self.endFrame.setText(ExportCafEndFrame)
        self.endFrame.setFixedWidth(DpiScale(70))
        self.endFrame.setToolTip(maya.stringTable[ u'y_xgenm_ui_dialogs_xgExportCaf.kEndFrameAnn'  ])
        ...
        self.exportButton = QPushButton(maya.stringTable[ u'y_xgenm_ui_dialogs_xgExportCaf.kExportFile'  ])
        self.exportButton.setFixedWidth(DpiScale(100))
        self.exportButton.setAutoRepeat(False)
        self.exportButton.setToolTip(maya.stringTable[ u'y_xgenm_ui_dialogs_xgExportCaf.kExportFileAnn'  ])
        self.connect(self.exportButton, QtCore.SIGNAL("clicked()"),
                     self.accept)
        hbox.addWidget(self.exportButton)
        self.cancelButton = QPushButton(maya.stringTable[ u'y_xgenm_ui_dialogs_xgExportCaf.kCancel'  ])
        self.cancelButton.setFixedWidth(DpiScale(100))
        self.cancelButton.setAutoRepeat(False)
        self.cancelButton.setToolTip(maya.stringTable[ u'y_xgenm_ui_dialogs_xgExportCaf.kCancelAnn'  ])
    ...
    if result == QDialog.Accepted:
        ...
        if len(fileName):
            if xgg.Maya:
                ...
                goPort = QMessageBox()
                goPort.setText(maya.stringTable[ u'y_xgenm_ui_dialogs_xgExportCaf.kExportToCafOnlyAvailableInMaya'  ])
                goPort.exec_()
