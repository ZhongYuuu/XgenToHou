    ...
    try:
        ...
        if name:
            if xgg.Maya:
                if dialog.getSetupForGroom():
                    ...
                    xglog.XGTip(maya.stringTable[u'y_xgenm_ui_dialogs_xgCreateDescription.kGroomingTip' ] )
                elif dialog.getMethod() == "Guides":
                    xglog.XGTip(maya.stringTable[u'y_xgenm_ui_dialogs_xgCreateDescription.kGuideToolTip' ] )
        ...
        if success and xgg.Maya:
            ...
            if dialog.getSetupForGroom():
                ...
                xgg.DescriptionEditor.activateTab( maya.stringTable[u'y_xgenm_ui_dialogs_xgCreateDescription.kGrooming' ] )
                # no playblast with grooming 
                setPlayblast = False
            else:
                # jump to the primitives tab
                xgg.DescriptionEditor.activateTab( maya.stringTable[u'y_xgenm_ui_dialogs_xgCreateDescription.kPrimitives' ] )
...
class CreateDescriptionUI(QDialog):
    ...
    def __init__(self,parent):
        ...
        self.setWindowTitle(maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kCreateXgenDescription'  ])
    ...
    def addPalette(self):
        self.collectionSectionLabel = self._addSectionLabel(maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kEachDescriptionMustBeStoredInACollection'  ])

        rowLayout = self._createRowLayout()
        radioButtonGroup = self._createVerticalGroupLayout(rowLayout)
        
        self.addDescriptionToRadio = QRadioButton(maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kAddDescriptionToExistingCollection'  ])
        ...
        self.createNewPaletteRadio = QRadioButton(maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kCreateNewCollectionNamed'  ])
    ...
    def addDescription(self):
        ...
        label = QLabel(maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kNewDescriptionName'  ])
    ...
    def addPrim(self):
        self._addSectionLabel(maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kWhatKindOfPrimitivesAreMadeByThisDescription'  ])
        rowLayout = self._createRowLayout()

        radioTexts = [maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kSplinesDescription'  ],
                      maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kGroomableSplinesDescription'  ],
                      maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kCustomGeometryArchives'  ],
                      maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kSpheresDescription'  ],
                      maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kCardsDescription'  ]]
    ...
    def addGen(self):
        self._addSectionLabel(maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kGenerateThePrimitives'  ])
        rowLayout = self._createRowLayout()

        radioTexts = [maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kRandomlyAcrossTheSurface'  ],
                      maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kInUniformRowsAndColumns'  ],
                      maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kAtPointsYouSpecify'  ]]
    ...
    def addMethod(self):
        self._addSectionLabel(maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kGroomThePrimitivesBy'  ])
        rowLayout = self._createRowLayout()

        radioTexts = [maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kPlacingGuides'  ],
                      maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kUsingAttributesControlledByExpressions'  ],
                      maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kUsingGroomingTools'  ]]
    ...
    def addButtons(self):
        ...
        self.createButton = QPushButton(maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kCreate'  ])
        ...
        self.cancelButton = QPushButton(maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kCancel'  ])
    ...
    def onCollidePalette( uiParent, newPalette, palette, palettePath ):
        ...
        if not uiParent:
            raise
        title = maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kCreateXgenDescriptionOverwrite'  ]
        text = maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kCollectionAlreadyExistsOnDisk'  ] % (palette,palettePath)
        mbox = QMessageBox( QMessageBox.NoIcon, title, text, QMessageBox.NoButton, uiParent )
        newPalNameBtn = QPushButton(maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kCreateInstead'  ] % newPalette)
        mbox.addButton( newPalNameBtn, QMessageBox.YesRole )
        overPalNameBtn = QPushButton(maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kOverwrite'  ] % palette)
    ...
    def onCollideDescription( uiParent, newDesc, desc, descPath ):
        ...
        if not uiParent:
            raise
        title = maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kCreateXgenDescriptionDescriptionClash'  ]
        text = maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kDescriptionAlreadyExistsOnDisk'  ] % (desc, descPath )                
        mbox = QMessageBox( QMessageBox.NoIcon, title, text, QMessageBox.NoButton, uiParent )
        newDescNameBtn = QPushButton(maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kCreateInstead2'  ] % newDesc)
    ...
    def createCB(self):
        ...
        if result:
            ...
            try:
                ...
                xglog.XGError( maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kErrorCreatingDescription'  ] % descName )
                pass
                self.reject()
...
def createDescription():
    ...
    if xgg.Maya:
        ...
        if len(geometries) == 0 and faces == None:
            xglog.XGTip(maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kPleaseSelectAPolygonSurfaceTip'  ] )
            return

        # check for namespace issues
        selNSpaces = xg.selectionNameSpaces()        
        if len(selNSpaces) > 1:            
            title = maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kCreateXgenDescriptionNamespace'  ]
            text = maya.stringTable[ u'y_xgenm_ui_dialogs_xgCreateDescription.kNamespaceIssueError'  ]
