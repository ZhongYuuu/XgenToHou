...
class StrayPercentageUI(QDialog):
    ...
    def __init__(self):
        ...
        self.setWindowTitle(maya.stringTable[ u'y_xgenm_ui_dialogs_xgStrayPercentage.kStrayPercentage'  ])
        self.setSizeGripEnabled(True)
        self.setMinimumWidth(DpiScale(550))
        layout = QVBoxLayout()
        self.helpText = QLabel(maya.stringTable[ u'y_xgenm_ui_dialogs_xgStrayPercentage.kStrayPercentageHelp'  ])
        self.helpText.setAlignment(QtCore.Qt.AlignCenter)
        layout.addWidget(self.helpText)
        self.stray = ExpressionUI("strayPercentage",
                                  maya.stringTable[ u'y_xgenm_ui_dialogs_xgStrayPercentage.kStrayPctgAnn'  ],
                                  "Description")
