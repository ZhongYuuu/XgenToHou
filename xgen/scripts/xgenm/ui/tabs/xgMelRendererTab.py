...
class MelRendererTabUI(RendererTabUI):
    def __init__(self):
        ...
        self.outputDir = BrowseUI("outputDir",
             maya.stringTable[ u'y_xgenm_ui_tabs_xgMelRendererTab.kOutputDirAnn'  ],
             "MelRenderer","","out",maya.stringTable[ u'y_xgenm_ui_tabs_xgMelRendererTab.kOutputDir'  ])
        self.layout().addWidget(self.outputDir)

        self.outputInstances = CheckBoxUI( maya.stringTable[ u'y_xgenm_ui_tabs_xgMelRendererTab.kOutputInstances'  ],"outputInstances",
             maya.stringTable[ u'y_xgenm_ui_tabs_xgMelRendererTab.kOutputInstancesAnn'  ],
             "MelRenderer")
        ...
        if ( xgg.Maya ):
            ...
            self.goButton = QPushButton(maya.stringTable[ u'y_xgenm_ui_tabs_xgMelRendererTab.kCreateMelFile'  ])
            self.goButton.setFixedWidth(DpiScale(145))
            self.goButton.setAutoRepeat(False)
            self.goButton.setToolTip(maya.stringTable[ u'y_xgenm_ui_tabs_xgMelRendererTab.kCreateMelAnn'  ])
    ...
    def renderMel(self):
        ...
        setProgressInfo(maya.stringTable[ u'y_xgenm_ui_tabs_xgMelRendererTab.kRenderingPrimitivesIntoMelFile'  ])
