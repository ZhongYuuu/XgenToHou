...
class UniformGeneratorTabUI(GeneratorTabUI):
    def __init__(self):
        GeneratorTabUI.__init__(self,'Uniform',maya.stringTable[ u'y_xgenm_ui_tabs_xgUniformGeneratorTab.kUniform'  ])
        # Widgets
        self.baseTopUI()
        self.spacing = FloatUI("spacing",
             maya.stringTable[ u'y_xgenm_ui_tabs_xgUniformGeneratorTab.kSpacingAnn'  ],
             "UniformGenerator",0.01,1000000,0.01,0.5,maya.stringTable[ u'y_xgenm_ui_tabs_xgUniformGeneratorTab.kSpacing'  ])
