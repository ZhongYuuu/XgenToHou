...
from .xgGeometryRendererTab import GeometryRendererTabUI
...
from .xgIgSplineBaseTab import IgSplineBaseTabUI
from .xgIgSplineDescriptionTab import IgSplineDescriptionTabUI
from .xgIgSplineModifierTab import IgSplineModifierTabUI
