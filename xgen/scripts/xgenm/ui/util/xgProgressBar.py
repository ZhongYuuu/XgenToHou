...
class _ProgressUI(QProgressDialog):
    ...
    def __init__(self):
        QProgressDialog.__init__(self,
                                       maya.stringTable[ u'y_xgenm_ui_util_xgProgressBar.kPleaseWait'  ],
                                       maya.stringTable[ u'y_xgenm_ui_util_xgProgressBar.kAbort'  ],0,50)
        self.setWindowModality(QtCore.Qt.ApplicationModal)
        self.setWindowTitle(maya.stringTable[ u'y_xgenm_ui_util_xgProgressBar.kXgenProgress'  ])
